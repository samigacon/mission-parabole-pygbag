...
# Redimensionner l'image LM proportionnellement
...
# Charger et redimensionner l'image de l'écran central
...
ecran_rect = ecran_image.get_rect(center=(screen_width // 2, screen_height // 2 - 100))  # Centré par rapport à "pont"
...
# Fonction pour dessiner l'écran explicatif
def draw_screen():
    ...
    explanation_text = [
        ...
        "",
        "Placer trois caméras pour capter la scène de manière impressionnante.",
        ...
        "Positionnez-les correctement afin de capturer les meilleurs angles",
        "pour le tournage."
    ]

    y_offset = ecran_rect.top + 80  # Position verticale initiale pour le texte explicatif
