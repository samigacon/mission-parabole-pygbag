...
image_car = pygame.image.load("Car.png")  # Image pour l'écran intermédiaire
...
def main():
    ...
    while running:
        ...
        # Écran intermédiaire
            ...
            screen.blit(image_car, (screen_width // 2 - image_car.get_width() // 2, screen_height // 2 - image_car.get_height() // 2))
            draw_text_centered("Simulation de trajectoire", font, WHITE, screen, screen_width // 2, screen_height // 2 + 100)
            draw_text_centered("pour le film Mission Parabole", font, WHITE, screen, screen_width // 2, screen_height // 2 + 140)
            pygame.draw.rect(screen, WHITE, (screen_width // 2 - 100, screen_height - 150, 200, 50), border_radius=15)
            draw_text_centered("Commencer", font, BLACK, screen, screen_width // 2, screen_height - 125)
