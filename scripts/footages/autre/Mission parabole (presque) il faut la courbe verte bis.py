...
def draw_curve():
    ...
    curve_color = RED  # La courbe reste rouge par défaut
...
def handle_button_click(mouse_pos):
    ...
    if not buttons_active:  # Si les boutons sont désactivés, ne rien faire
        return
...
def handle_simulation_buttons(mouse_pos):
    global A, B, C, car_x, car_y, car_angle, simulation_active, show_success_message, show_error_message, buttons_active
    ...
    if reset_button_rect.collidepoint(mouse_pos):
        ...
        curve_color = RED  # Réinitialiser la couleur de la courbe
